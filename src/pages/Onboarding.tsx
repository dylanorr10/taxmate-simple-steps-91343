      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Tax & accounting made simple for tradespeople
          </p>
        </div>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex items-start space-x-3 bg-secondary/5 p-4 rounded-xl border border-secondary/10">
            <CheckCircle className="w-6 h-6 text-primary flex-shrink-0 mt-0.5" />
            <div>
              <p className="font-semibold text-foreground">Built for Tradespeople</p>
              <p className="text-sm text-muted-foreground">
                Designed specifically for electricians, plumbers, builders, and more
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="px-6 py-4 border-t border-border">
        <div className="flex space-x-3">
          ...
          <button
            onClick={handleNext}
            disabled={
              !formData.name || !formData.email || formData.password.length < 8
            }
